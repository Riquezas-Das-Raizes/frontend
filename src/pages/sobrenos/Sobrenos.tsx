  ...
  return (
    <div className="background">
      ...
      <div>
        ...
        <p className="flex justify-center item-center p-4">
      ...
      <div>
        ...
        <p className="flex justify-center item-center p-4">
          A Riqueza das Raízes tem como missão fomentar a economia sustentável e
          o comércio justo, oferecendo uma plataforma onde a autenticidade e a
